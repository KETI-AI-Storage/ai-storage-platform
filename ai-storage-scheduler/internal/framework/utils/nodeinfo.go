...
type GPUInfo struct {
	UUID              string
	Arch              string
	UtilizationPct    float64 // 0–100, from DCGM_FI_DEV_GPU_UTIL
	MemoryUsedMB      int64   // from DCGM_FI_DEV_FB_USED
	MemoryTotalMB     int64   // from DCGM_FI_DEV_FB_TOTAL
	TemperatureCelsius float64 // from DCGM_FI_DEV_GPU_TEMP
	PowerWatts        float64 // from DCGM_FI_DEV_POWER_USAGE
}
